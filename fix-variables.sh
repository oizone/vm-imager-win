...
find autounattend/2016 -type f -exec sed -i "s/###DATACENTER_KEY###/${DATACENTER_2016_KEY}/g" {} \;
find autounattend/2019 -type f -exec sed -i "s/###STANDARD_KEY###/${STANDARD_2019_KEY}/g" {} \;
find autounattend/2019 -type f -exec sed -i "s/###DATACENTER_KEY###/${DATACENTER_2019_KEY}/g" {} \;
